...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('eventos')->insert(['id'=>'1', 'evento'=>'Noche de Rock',        'fecha'=>'2018-11-29', 'horario'=>'16:00', 'lugar'=>'Complejo Deportivo Ferroviario', 'descripcion'=>'Eklectica, Crydom, Arcangel y Deuce tributo a Kiss']);
        \DB::table('eventos')->insert(['id'=>'2', 'evento'=>'Noche de Folclore',  'fecha'=>'2018-11-29', 'horario'=>'19:00', 'lugar'=>'Complejo Deportivo Ferroviario', 'descripcion'=>'Yana Mayu, Kuwabara, Punchay y Kjarkas']);
        \DB::table('eventos')->insert(['id'=>'3', 'evento'=>'Noche de Cumbia',      'fecha'=>'2018-11-30', 'horario'=>'16:00', 'lugar'=>'Complejo Deportivo Ferroviario', 'descripcion'=>'Ruddy Danel Y Angela Leyva']);
